        ...
        <div class="modal-content card-shadow-custom">
            <div class="modal-header">
                ...
                <div class="d-flex align-items-center">
                    <h5 id="status-detail-out-inventory-manage"></h5>
                    <button type="button" class="close" onclick="closeModalDetailOutInventoryManage()" onkeypress="closeModalDetailOutInventoryManage()">
...
@push('scripts')
    <script type="text/javascript"
            src="{{ asset('..\js\manage\inventory\out_inventory\detail.js?version=3')}}"></script>
@endpush
