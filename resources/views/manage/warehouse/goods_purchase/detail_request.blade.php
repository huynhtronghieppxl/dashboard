<div class="modal fade" id="modal-detail-request-goods-purchase-warehouse" data-keyboard="false" data-backdrop="static">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="d-flex">
                    ...
                    <button type="button" class="close ml-4" onclick="closeModalDetailOrderRequestWarehouse()" onkeypress="closeModalDetailOrderRequestWarehouse()">
                        <i class="fi-rr-cross"></i>
                    </button>
                </div>
            </div>
            <div class="modal-body text-left background-body-color" id="loading-detail-request-goods-purchase-warehouse">
                <div class="row d-flex">
                    <div class="col-lg-8 edit-flex-auto-fill pl-0">
                        <div class="card card-block w-100">
                            ...
                            <div class="table-responsive new-table">
                                <table class="table" id="table-material-detail-request-goods-purchase-warehouse">
                                    <thead>
                                    <tr>
                    ...
                    <div class="col-lg-4 edit-flex-auto-fill px-0">
                        <div class="card card-block flex-sub" id="box-list-detail-request-goods-purchase-warehouse">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <h6 class="f-w-400 text-muted col-form-label-fz-15" id="branch-detail-request-goods-purchase-warehouse"></h6>
                                </div>
                                <div class="col-lg-6">
                                    <label class="f-w-600 col-form-label-fz-15">@lang('app.supplier-order.detail-request.inventory')</label>
                                    <h6 class="f-w-400 text-muted col-form-label-fz-15" id="inventory-detail-request-goods-purchase-warehouse"></h6>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    ...
                                    <div class="d-flex mb-1">
                                        ...
                                        <h6 class="text-muted f-w-400 col-form-label-fz-15 reset-data-detail-payment-bill class-link" id="employee-detail-request-goods-purchase-warehouse" style="margin: auto 5px"></h6>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <label class="f-w-600 col-form-label-fz-15">@lang('app.supplier-order.detail-request.request-date-create')</label>
                                    <h6 class="f-w-400 text-muted col-form-label-fz-15" id="create-detail-request-goods-purchase-warehouse">{{date('d/m/Y')}} {{date('H:m')}}</h6>
                                </div>
                            </div>
{{--                            <div class="row">--}}
{{--                                <div class="col-lg-12">--}}
{{--                                    <label class="f-w-600 col-form-label-fz-15">@lang('app.supplier-order.detail-request.date')</label>--}}
{{--                                    <h6 class="f-w-400 text-muted col-form-label-fz-15" id="date-detail-request-goods-purchase-warehouse">{{date('d/m/Y')}} {{date('H:m')}}</h6>--}}
{{--                                </div>--}}
{{--                            </div>--}}
                            <div class="row d-none" id="div-reason-detail-request-goods-purchase-warehouse">
                                <div class="col-lg-12">
                                    <label class="f-w-600 col-form-label-fz-15">@lang('app.supplier-order.detail-request.reason')</label>
                                    <h6 class="f-w-400 text-muted col-form-label-fz-15" id="reason-detail-request-goods-purchase-warehouse"></h6>
                                </div>
                            </div>
                            ...
                            <div class="row mt-2">
                                <div class="col-lg-12">
                                    ...
                                    <label class="f-w-600 col-form-label-fz-15 f-right"
                                           id="total-price-detail-request-goods-purchase-warehouse">0</label>
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    <script type="text/javascript" src="/js/manage/warehouse/goods_purchase/detail_order_request.js?version=1"></script>
@endpush
