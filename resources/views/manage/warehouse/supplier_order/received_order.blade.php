    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
                                            ...
                                            <div class="col-lg-12 mx-0 px-0">
                                                <div class="col-lg-12 pr-0 select-material-box">
                                                    ...
                                                    <label class="icon-validate"><i
                                                            class="icofont icofont icofont-ui-map"></i> Giá tiền (VNĐ)
                                                    </label>
                                                    <div class="line"></div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group validate-group">
                                        <div class="form-validate-input">
                                            ...
                                            <label>
                                                <i class="typcn typcn-document-text"></i>
                                                @lang('app.supplier-order.received-order.vat') (%)
                                            </label>
                                            <div class="line"></div>
                                        </div>
                                        <div class="link-href float-right">
            ...
            <div class="modal-footer">
                <button type="button"
                        class="btn btn-grd-primary waves-effect" onclick="saveModalReceivedOrderSupplierOrder()"
                        onkeypress="saveModalReceivedOrderSupplierOrder()">@lang('app.supplier-order.received-order.save')
                </button>
            </div>
        </div>
    </div>
...
@push('scripts')
    <script type="text/javascript"
            src="{{ asset('js/manage/warehouse/supplier_order/received_order.js?version=6')}}"></script>
@endpush
