        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <button type="button" class="close" onclick="closeModalDetailRequestSupplierOrder()"
                            onkeypress="closeModalDetailRequestSupplierOrder()">
                            ...
                            <div class="table-responsive new-table">
                                <table class="table" id="table-material-detail-request-supplier-order">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">@lang('app.supplier-order.detail-request.name')</th>
                    ...
                    <div class="col-lg-4 edit-flex-auto-fill px-0">
                        <div class="card card-block flex-sub" id="box-list-detail-request-supplier-order">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <label
                                        class="f-w-600 col-form-label-fz-15">@lang('app.supplier-order.detail-request.branch')</label>
                                    <h6 class="f-w-400 text-muted col-form-label-fz-15"
                                        id="branch-detail-request-supplier-order"></h6>
                                </div>
                                <div class="col-lg-6">
                                    <label
                                        class="f-w-600 col-form-label-fz-15">@lang('app.supplier-order.detail-request.inventory')</label>
                                    <h6 class="f-w-400 text-muted col-form-label-fz-15"
                                        id="inventory-detail-request-supplier-order"></h6>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-lg-6">
                                    <label
                                        class="f-w-600 col-form-label-fz-15">@lang('app.supplier-order.detail-request.employee')</label>
                                    <div class="d-flex mb-1">
                                        <img class="image-size-detail img-radius" src="/images/tms/default.jpeg"
                                             id="image-employee-detail-request-order-supplier-order"
                                             onerror="this.src='/images/tms/default.jpeg'">
                                        <h6 class="text-muted f-w-400 col-form-label-fz-15 reset-data-detail-payment-bill class-link"
                                            id="employee-detail-request-supplier-order" style="margin: auto 5px"></h6>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <label
                                        class="f-w-600 col-form-label-fz-15">@lang('app.supplier-order.detail-request.request-date-create')</label>
                                    <h6 class="f-w-400 text-muted col-form-label-fz-15"
                                        id="create-detail-request-supplier-order">{{date('d/m/Y')}} {{date('H:m')}}</h6>
                                </div>
                            </div>
                            {{--                            <div class="row">--}}
                            {{--                                <div class="col-lg-12">--}}
                            ...
                            <div class="row d-none" id="div-reason-detail-request-supplier-order">
                                <div class="col-lg-12">
                                    <label
                                        class="f-w-600 col-form-label-fz-15">@lang('app.supplier-order.detail-request.reason')</label>
                                    <h6 class="f-w-400 text-muted col-form-label-fz-15"
                                        id="reason-detail-request-supplier-order"></h6>
                                </div>
                            </div>
...
@push('scripts')
    <script type="text/javascript"
            src="{{ asset('js/manage/warehouse/supplier_order/detail_request.js?version=2')}}"></script>
@endpush
