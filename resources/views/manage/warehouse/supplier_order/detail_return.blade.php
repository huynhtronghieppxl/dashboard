                            ...
                            <div class="table-responsive new-table">
                                <table class="table" id="table-material-detail-return-order">
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">@lang('app.supplier-order.detail-return-order.name')</th>
...
@push('scripts')
    <script type="text/javascript"
            src="{{ asset('js/manage/warehouse/supplier_order/detail_return.js?version=3')}}"></script>
@endpush
