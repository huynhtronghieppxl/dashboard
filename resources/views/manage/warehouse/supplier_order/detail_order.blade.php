            ...
            <div class="modal-body background-body-color text-left" id="loading-detail-order-supplier-order">
                <div class="row d-flex">
                            ...
                            <div class="table-responsive new-table">
                                <table class="table"
                                    ...
                                    <tr>
                                        ...
                                        <th class="text-center">@lang('app.supplier-order.detail-order.name')</th>
                                        <th>@lang('app.supplier-order.detail-order.quantity')</th>
                                        <th>@lang('app.supplier-order.detail-order.price')</th>
                                        <th>@lang('app.supplier-order.detail-order.total-price')</th>
                                        <th></th>
                                        <th class="d-none"></th>
                                    </tr>
                                    </thead>
                    ...
                    <div class="col-lg-4 edit-flex-auto-fill px-0">
                        <div class="card card-block flex-sub" id="box-list-detail-order-supplier-order"
...
{{--                                </div>--}}
                            ...
                            <div class="row d-none" id="div-employee-detail-order-supplier-order">
                                ...
                                <div class="col-lg-6">
                                    <label
                                        class="f-w-600 col-form-label-fz-15 mb-1">@lang('app.supplier-order.detail-order.time')</label>
                            ...
                            <div class="row d-none" id="div-supplier-system-detail-order-supplier-order">
                                <div class="col-lg-6">
                                    ...
                                    <div class="d-flex mb-1">
                                        ...
                                        <label class="f-w-400 text-muted col-form-label-fz-15 mb-0 mt-1 ml-1" id="supplier-system-detail-order-supplier-order"></label><br>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <label
                            ...
                            <div class="row d-none" id="div-cancel-detail-order-supplier-order">
                                ...
                                <div class="d-flex mb-1">
                                    <img src="" id="image-employee-cancel-detail-order-supplier-order" onerror="this.src='/images/tms/default.jpeg'" class="img-radius" alt="" style="width: 2rem;height: 2rem"/>
                                    <label class="f-w-400 text-muted col-form-label-fz-15 mb-0 mt-1 ml-1 class-link" id="employee-cancel-detail-order-supplier-order"></label>
                                </div>
                                </div>
                                <div class="col-lg-6">
                                    <label
...
@push('scripts')
    <script type="text/javascript"
            src="{{ asset('js/manage/warehouse/supplier_order/detail_order.js?version=14')}}"></script>
@endpush
