...
@section('content')
    <div class="page-wrapper">
        <div class="page-body">
            <div class="card card-block">
                <ul class="nav nav-tabs md-tabs" role="tablist" id="nav-supplier-order-manage">
                            ...
                            <div class="table-responsive new-table">
                                ...
                                <table class="table" id="table-waiting-supplier-order">
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="2">@lang('app.supplier-order.supplier')</th>
                                        <th rowspan="2">@lang('app.supplier-order.employee')</th>
                                        <th rowspan="2">@lang('app.supplier-order.quantity')</th>
                                        <th>@lang('app.supplier-order.amount')</th>
                        ...
                        <div class="table-responsive new-table">
                            ...
                            <table class="table" id="table-order-supplier-order">
                                ...
                                <tr>
                                    ...
                                    <th rowspan="2">@lang('app.supplier-order.employee')</th>
                                    <th rowspan="2">@lang('app.supplier-order.quantity')</th>
                                    <th>@lang('app.supplier-order.amount')
                                    ...
                                    <th>@lang('app.supplier-order.discount')</th>
                                    <th>@lang('app.supplier-order.vat')</th>
                                    <th>@lang('app.supplier-order.total-amount')
                                        <i class="fa fa-exclamation-circle text-inverse pointer" data-toggle="tooltip"
                                           data-placement="top"
                        ...
                        <div class="table-responsive new-table">
                            ...
                            <table class="table" id="table-done-supplier-order">
                                ...
                                <tr>
                                    ...
                                    <th rowspan="2">@lang('app.supplier-order.code')</th>
                                    <th rowspan="2">@lang('app.supplier-order.supplier')</th>
                                    <th rowspan="2">@lang('app.supplier-order.employee-done')</th>
                                    <th rowspan="2">@lang('app.supplier-order.quantity')</th>
                                    <th>@lang('app.supplier-order.amount')
                                        <i class="fa fa-exclamation-circle text-inverse pointer" data-toggle="tooltip"
                                           data-placement="top"
                                    ...
                                    <th>@lang('app.supplier-order.return-amount')</th>
                                    <th>@lang('app.supplier-order.payment-amount')
                                        <i class="fa fa-exclamation-circle text-inverse pointer" data-toggle="tooltip"
                                           data-placement="top"
                        ...
                        <div class="table-responsive new-table">
                            ...
                            <table class="table" id="table-cancel-supplier-order">
                                ...
                                <tr>
                                    ...
                                    <th rowspan="2">@lang('app.supplier-order.code')</th>
                                    <th rowspan="2">@lang('app.supplier-order.supplier')</th>
                                    <th rowspan="2">@lang('app.supplier-order.employee-cancel')</th>
                                    <th rowspan="2">@lang('app.supplier-order.quantity')</th>
                                    <th>@lang('app.supplier-order.amount')
                                        <i class="fa fa-exclamation-circle text-inverse pointer" data-toggle="tooltip"
                                           data-placement="top"
                        ...
                        <div class="table-responsive new-table">
                            ...
                            <table class="table" id="table-return-supplier-order">
                                ...
                                <tr>
                                    ...
                                    <th rowspan="2">@lang('app.supplier-order.code')</th>
                                    <th rowspan="2">@lang('app.supplier-order.supplier')</th>
                                    <th rowspan="2">@lang('app.supplier-order.employee-return')</th>
                                    <th rowspan="2">@lang('app.supplier-order.quantity')</th>
                                    <th>@lang('app.supplier-order.amount')
                                        <i class="fa fa-exclamation-circle text-inverse pointer" data-toggle="tooltip"
                                           data-placement="top"
    ...
    @include('manage.warehouse.supplier_order.return_order')
    @include('manage.warehouse.supplier_order.detail_return')
    @include('manage.warehouse.supplier_order.create')
    @include('manage.warehouse.supplier_order.update_request')
    @include('manage.warehouse.supplier_order.detail_request')
    @include('manage.warehouse.supplier_order.update_restaurant')
    @include('manage.warehouse.supplier_order.detail_restaurant')
    @include('manage.warehouse.supplier_order.received_order')
@endsection
@push('scripts')
    <script type="text/javascript"
            src="{{ asset('js/manage/warehouse/supplier_order/index.js?version=6',env('IS_DEPLOY_ON_SERVER'))}}"></script>
