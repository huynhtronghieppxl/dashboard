        ...
        <div class="modal-content">
                                    ...
                                    <div class="form-validate-select">
                                        <div class="pr-0 select-material-box">
                                            <select class="js-example-basic-single"
                                                    id="select-list-request-export-warehouse">
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-validate-textarea">
                                    <div class="form__group pt-2 mb-2">
                                        <textarea class="form__field" rows="5" cols="6"
                                                  id="note-create-request-export-warehouse" data-note-max-length="255" ></textarea>
            ...
            <div class="modal-footer">
                <button type="button" class="btn-renew d-none"
                        onclick="resetDataCreateRequestExportWarehouse()"
...
@push('scripts')
    <script type="text/javascript"
            src="/js/manage/warehouse/export_inventory/create_request.js?version=1"></script>
@endpush
