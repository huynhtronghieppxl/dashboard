...
<div class="modal fade" id="modal-detail-bill-manage" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">@lang('app.bill-manage.detail.title')</h4>
                <div class="d-flex align-items-center">
                    <h5 class="m-0" id="status-detail-bill-manage"></h5>
                    <button type="button" class="close ml-4" onclick="closeModalDetailBillManage()" onkeypress="closeModalDetailBillManage()">
                ...
                <div class="row d-flex py-0">
                    <div class="col-lg-8 edit-flex-auto-fill m-0" style="flex-direction: column">
                        <ul class="nav nav-tabs md-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#tab1-detail-bill-manage" role="tab" id="tab-detail-bill-manage-1" aria-expanded="true">@lang('app.bill-manage.detail.tab1')
                                    ...
                                    <div class="table-responsive new-table">
                                        <table id="table-detail-order" class="table">
                                            ...
                                            <tr>
                                                ...
                                                <th rowspan="2">
                                                    @lang('app.bill-manage.detail.vat-amount')
                                                    <i class="fi-rr-exclamation tooltip_formula" style="vertical-align: sub; display: initial !important;">
                                                        <div class="row tooltip_formula_wrapper">
                                                            <p>
                                                                Tiền VAT =
                                                            </p>
                                                            <p >
                                                                <span>(Giá bán - Giảm giá) * %VAT</span><br>
                                                            </p>
                                                        </div>
                                                    </i>
                                                </th>
                                            ...
                                            <tr>
                                                <th class="seemt-fz-14" id="total-amount-detail-bill-treasurer"></th>
                                            </tr>
                                            </thead>
                                        </table>
                                    </div>
                                    <div class="table-responsive new-table d-none">
                                        <table id="table-detail-order-export" class="table">
                                            ...
                                            <tr>
                                                ...
                                                <th rowspan="2">@lang('app.bill-manage.detail.quantity-table')</th>
                                                <th rowspan="2">@lang('app.bill-manage.detail.price')</th>
                                                <th class="text-right" rowspan="1">@lang('app.bill-manage.detail.money-table')</th>
                                                <th class="text-right" rowspan="2">@lang('app.bill-manage.detail.vat-amount')</th>
                                                <th rowspan="2">@lang('app.bill-manage.detail.status-table')</th>
                                                <th rowspan="2">@lang('app.bill-manage.detail.action-table')</th>
                                                <th rowspan="2" class="d-none"></th>
                                            </tr>
                                            <tr>
                                                <th class="text-right seemt-fz-14" id="total-amount-detail-bill-treasurer"></th>
                                            </tr>
                                            </thead>
                                        </table>
                                    </div>
                                    ...
                                    <div class="table-responsive new-table">
                                        ...
                                        <table class="table" id="table-receipt-detail-bill-manage">
                                            ...
                                            <tr>
                                                ...
                                                <th class="text-right">@lang('app.bill-manage.detail.amount')</th>
                                                <th rowspan="2">@lang('app.bill-manage.detail.action')</th>
                                                <th class="d-none" rowspan="2"></th>
                                            </tr>
                                            <tr>
                                                <th id="total-receipt-detail-bill-manage" class="text-right seemt-fz-14"></th>
                                            </tr>
                                            </thead>
                                        </table>
                                    </div>
...
{{--                            </div>--}}
                            ...
                            <div class="row mt-2 mb-2">
                                ...
                                <div class="col-lg-12">
                                    <label class="f-w-600 col-form-label-fz-15">Giảm giá</label> (<label class="f-w-400 col-form-label-fz-15" id="detail-discount-bill-manage"></label>)
...
{{--                                    <label class="f-w-400 col-form-label-fz-15 f-right"--}}
{{--                                           id="accumulate-point-detail-bill-manage">0</label>--}}
{{--                                </div>--}}
...
{{--                                </div>--}}
                            ...
                            <div class="px-3 mt-2">
                                <label
                                    class="f-w-600 col-form-label-fz-15">Tổng thanh toán</label>
                                <label class="f-w-600 col-form-label-fz-15 f-right"
                                       id="total-detail-bill-manage">0</label>
                            </div>
                            <div class="px-3 mt-2">
                                <label
                                    class="f-w-600 col-form-label-fz-15">Sử dụng điểm nạp</label>
                                <label class="f-w-400 col-form-label-fz-15 f-right"
                                       id="recharge-point-detail-bill-manage">0</label>
                            </div>
                            <div class="px-3 mt-2">
                                <label
                                    class="f-w-600 col-form-label-fz-15">Thanh toán </label>
                                <label class="f-w-400 col-form-label-fz-15 f-right"
                                       id="total-point-payment-detail-bill-manage">0</label>
                            </div>
                        </div>
                    </div>
                </div>
...
@push('scripts')
    <script type="text/javascript"
            src="{{asset('/js/manage/bill/detail.js?version=6',env('IS_DEPLOY_ON_SERVER'))}}"></script>
@endpush
