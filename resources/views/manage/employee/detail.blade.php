        ...
        <div class="modal-content" id="loading-modal-detail-employee-manage">
            <div class="modal-header">
                ...
                <div class="d-flex align-items-center">
                    <h5 id="date-status-detail-employee-manage" class="date-reset-data-detail-employee-manage"   style="margin-left: auto"></h5>
...
@push('scripts')
    <script type="text/javascript" src="{{asset('/js/manage/employee/detail.js?version=3',env('IS_DEPLOY_ON_SERVER'))}}"></script>
@endpush
