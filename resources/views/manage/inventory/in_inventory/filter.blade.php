<div class="select-filter-dataTable">
    ...
    <div class="time-filer-dataTale">
        <div class="seemt-group-date">
            ...
            <input class="from-date-in-inventory-manage" type="text" value="1/{{date('m/Y')}}">
        </div>
        <span class="input-group-addon custom-find"><i class="fi-rr-angle-double-small-right"></i></span>
        <div class="seemt-group-date">
            <i class="fi-rr-calendar"></i>
            <input class="to-date-in-inventory-manage" type="text" value="{{date('d/m/Y')}}">
        </div>
        <button class="search-date-btn-in-inventory-manage"><i class="fi-rr-filter"></i></button>
    </div>
</div>
