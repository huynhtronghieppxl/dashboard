        ...
        <div class="modal-content card-shadow-custom">
            <div class="modal-header">
                ...
                <div class="d-flex align-items-center">
                    <h5 class="m-0" id="status-detail-in-inventory-manage"></h5>
                    <button type="button" class="close ml-4" onclick="closeModalDetailInInventoryManage()" onkeypress="closeModalDetailInInventoryManage()">
...
@push('scripts')
    <script type="text/javascript" src="{{asset('/js/manage/inventory/in_inventory/detail.js?version=4',env('IS_DEPLOY_ON_SERVER'))}}"></script>
@endpush
