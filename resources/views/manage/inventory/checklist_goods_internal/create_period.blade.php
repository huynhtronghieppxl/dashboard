<div class="modal fade" id="modal-create-period-checklist-goods-internal-manage" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content card-shadow-custom">
            <div class="modal-header">
                <h4 class="modal-title">@lang('app.checklist-goods-internal-manage.create.title')</h4>
                <button type="button" class="close" onclick="closeModalCreatePeriodCheckListGoodsInternalManage()" onkeypress="closeModalCreatePeriodCheckListGoodsInternalManage()">
                    <i class="fi-rr-cross"></i>
                </button>
            </div>
            <div class="modal-body text-left background-body-color"
                 id="loading-modal-create-period-checklist-goods-internal-manage">
                <div class="row">
                    <div class="col-lg-8 edit-flex-auto-fill px-0">
                        <div class="card card-block flex-sub mr-0">
                            ...
                            <div class="table-responsive new-table">
                                <table class="table"
                                       id="table-material-create-period-checklist-goods-internal-manage">
                                    <thead>
                                    <tr>
                    ...
                    <div class="col-lg-4 edit-flex-auto-fill px-0">
                        <div class="card card-block flex-sub" id="boxlist-create-period-checklist-goods-internal-manage">
                                ...
                                <div class="form-validate-select ">
                                    <div class="col-lg-12 mx-0 px-0">
                                        <div class="col-lg-12 pr-0 select-material-box">
                                            <select id="select-inventory-create-period-checklist-goods-internal-manage"
                                                ...
                                                <option
                                                    value="3">@lang('app.checklist-goods-internal-manage.create.title3')</option>
                                                <option
                                                    value="4">@lang('app.checklist-goods-internal-manage.create.title4')</option>
                                            </select>
                                            <label class="icon-validate">@lang('app.checklist-goods-internal-manage.create.inventory')</label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <label
                                        ...
                                        : <label class="f-w-400"
                                                 id="checklist-date-create-period-checklist-goods-internal-manage">---</label></label>
                                </div>
                                <div class="col-lg-6">
                                    <label
                                        ...
                                        :
                                        <label
                                            id="date-create-period-checklist-goods-internal-manage">{{date('d/m/Y')}}</label></label>
                                </div>
                            </div>
                                ...
                                <div class="form-validate-textarea">
                                    <div class="form__group pt-2 mb-2">
                                        <textarea class="form__field" rows="5" cols="6"   data-note-max-length="255"
                                                  id="note-create-period-checklist-goods-internal-manage"
                                        ></textarea>
                                        <label for="note-create-period-checklist-goods-internal-manage"
            ...
            <div class="modal-footer">
                <button type="button" class="btn-renew d-none" data-toggle="tooltip" data-placement="top" data-original-title="Đặt lại"
                        onclick="resetModalCreatePeriodCheckListGoodsInternalManage()"
                        onkeypress="resetModalCreatePeriodCheckListGoodsInternalManage()">
                    <i class="fa fa-eraser"></i>
                </button>
                <div class="btn seemt-blue seemt-bg-blue seemt-btn-hover-blue"
                        onclick="saveModalCreatePeriodCheckListGoodsInternalManage()"
                        onkeypress="saveModalCreatePeriodCheckListGoodsInternalManage()">
...
@push('scripts')
    <script type="text/javascript"
            src="{{asset('/js/manage/inventory/checklist_goods_internal/create_period.js?version=1',env('IS_DEPLOY_ON_SERVER'))}}"></script>
@endpush
