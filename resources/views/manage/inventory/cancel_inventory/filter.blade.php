<div class="select-filter-dataTable">
    <div class="form-validate-select">
        <div class="pr-0 select-material-box">
            <select class="js-example-basic-single select-brand select-brand-cancel-inventory-manage">
    ...
    <div class="form-validate-select ml-3">
        <div class="pr-0 select-material-box">
            <select class="js-example-basic-single select-branch select-branch-cancel-inventory-manage">
            </select>
        </div>
    </div>
    <div class="time-filer-dataTale filter-date">
        <div class="seemt-group-date">
            ...
            <input class="from-date-cancel-inventory-internal-manage" type="text" value="1/{{date('m/Y')}}">
        </div>
