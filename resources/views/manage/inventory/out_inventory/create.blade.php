<style>
    #modal-create-out-inventory-manage .new-table .select-filter-dataTable {
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-left background-body-color" id="loading-create-out-inventory-manage">
                <div class="  d-flex">
                    <div class="col-lg-9 edit-flex-auto-fill px-0 flex-column">
                        <ul class="nav nav-tabs md-tabs " id="tab-create-out-inventory-manage" role="tablist">
                            <li class="nav-item">
                        ...
                        <div class="card-block card w-100   m-0">
                    ...
                    <div class="col-lg-3 edit-flex-auto-fill px-0">
                        <div class="card-block card flex-sub mr-0">
                            ...
                            <div class="form-group validate-group m-t-10">
                                <div class="form-validate-input">
                                    <input type="text" id="date-create-out-inventory-manage"
                                           ...
                                           value="{{date('d/m/Y')}}">
                                    <label>
                                         @lang('app.out-inventory-manage.create.delivery')
                                ...
                                <div class="form-validate-select ">
                                    <div class="col-lg-12 mx-0 px-0">
                                        <div class="col-lg-12 pr-0 select-material-box">
                                            ...
                                            <label>
                                                 @lang('app.out-inventory-manage.create.inventory-target')
                                                @include('layouts.start')
                                            </label>
                                            <div class="line"></div>
                                        </div>
                                ...
                                <div class="form-validate-textarea">
                                    <div class="form__group pt-2 mb-2">
                                        <textarea class="form__field" rows="5" cols="6"  data-note-max-length="255"
                                                  id="note-create-out-inventory-manage"></textarea>
                                        <label for="note-create-out-inventory-manage"
                                               class="form__label icon-validate">@lang('app.out-inventory-manage.create.note')
                                        </label>
            ...
            <div class="modal-footer">
                ...
                <div class="btn seemt-blue seemt-bg-blue seemt-btn-hover-blue"
                     onclick="saveModalCreateOutInventoryManage()"
                     title="@lang('app.out-inventory-manage.create.title-save')"
                     onkeypress="saveModalCreateOutInventoryManage()">
...
@push('scripts')
    <script type="text/javascript"
            src="{{asset('/js/manage/inventory/out_inventory/create.js?version=6',env('IS_DEPLOY_ON_SERVER'))}}"></script>
