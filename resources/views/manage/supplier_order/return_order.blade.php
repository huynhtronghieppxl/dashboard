...
{{--                                </div>--}}
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="d-flex mb-1">
                                        ...
                                        <label class="f-w-400 text-muted col-form-label-fz-15 mb-0 mt-1 ml-1 class-link" id="employee-return-order-supplier-order"></label>
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <label
                                    ...
                                    <div class="form-group validate-group">
                                        <div class="form-validate-textarea">
                                            <div class="form__group pt-2">
                                                <textarea class="form__field" id="note-return-order-supplier-order" cols="5" rows="5" data-note="1" data-note-max-length="255"></textarea>
            ...
            <div class="modal-footer">
                <div class="btn seemt-blue seemt-bg-blue seemt-btn-hover-blue" onclick="saveModalReturnSupplierOrder()"
                        onkeypress="saveModalReturnSupplierOrder()">
...
@push('scripts')
    <script type="text/javascript"
            src="/js/manage/supplier_order/return_order.js?version=2"></script>
@endpush
