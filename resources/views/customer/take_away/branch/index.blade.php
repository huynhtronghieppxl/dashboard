...
@section('content')
                    ...
                    <div class="card">
                        <div class="col-sm-12">
                            <div class="row mt-3" id="list-branch-take-away">
                                @foreach(collect(Session::get(SESSION_KEY_DATA_BRANCH))->where('is_office' , 0)->where('status' , 1) as $key => $item)
                                                    ...
                                                    <ul class="profile-controls">
                                                        <li>
                                                            <label title=""
                                                                   ...
                                                                   data-type="{{$key}}"
                                                                   data-toggle="tooltip"
                                                                   data-take-away="{{ $item['is_have_take_away'] }}"
                                                    ...
                                                    <ul class="profile-controls"
                                                        ...
                                                        <li data-toggle="tooltip"
                                                            ...
                                                            <input type="checkbox" class="js-switch"
                                                                   ...
                                                                   onchange="changeStatusSettingTakeAway($(this))">
                                                        </li>
                                                    </ul>
                                                @else
                                                    <ul class="profile-controls"
                                                        ...
                                                        <div class="profile-branch">
                                                            <div class="profile-branch-thumb">
                                                                <img alt="author"
                                                                     ...
                                                                     src="{{ Session::get(SESSION_NODE_KEY_BASE_URL_ADS) . $item['image_logo']   }} ">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-9">
            ...
            <div id="data-visible-take-away" class="d-none">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-type="0" data-toggle="tab" data-type="1"
                           href="#tab1-take-away" role="tab" aria-expanded="true">
                            @lang('app.take-away-branch.tab1')
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-type="1" data-toggle="tab" data-type="2"
                           href="#tab2-take-away" role="tab" aria-expanded="false">
                            @lang('app.take-away-branch.tab2')
                            <span class="label label-warning" id="total-record-drink">0</span>
                        </a>
                        <div class="slide"></div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-type="2" data-toggle="tab" data-type="4"
                           href="#tab3-take-away" role="tab" aria-expanded="false">
                            @lang('app.take-away-branch.tab3')
                            <span class="label label-primary"
                                  id="total-record-sea-food">0</span>
                        </a>
                        <div class="slide"></div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-type="3" data-toggle="tab" data-type="3"
                           href="#tab4-take-away" role="tab" aria-expanded="false">
                            @lang('app.take-away-branch.tab4')
                ...
                <div class="card card-block">
                    <div class="tab-content">
                        <div class="tab-pane active" data-type="4" id="tab1-take-away" role="tabpanel">
                            <div class="table-responsive new-table">
                                @include('customer.take_away.branch.filter')
                                <table class="table " id="table-food-take-away">
                                    <thead>
                                    <tr>
                                        <th>@lang('app.take-away-branch.stt')</th>
                                        <th>@lang('app.take-away-branch.name')</th>
                                        <th>@lang('app.take-away-branch.unit')</th>
                                        <th>@lang('app.take-away-branch.category')</th>
                                        <th>@lang('app.take-away-branch.price')</th>
                                        <th>@lang('app.take-away-branch.vat')</th>
                                        <th>@lang('app.take-away-branch.profit')</th>
                                        <th></th>
                                        <th class="d-none"></th>
                                    </tr>
                                    </thead>
                        ...
                        <div class="tab-pane" id="tab3-take-away" role="tabpanel">
                            <div class="table-responsive new-table">
                                @include('customer.take_away.branch.filter')
                                <table class="table " id="table-sea-food-take-away">
                                    <thead>
                                    <tr>
                                        <th>@lang('app.take-away-branch.stt')</th>
                                        <th>@lang('app.take-away-branch.name')</th>
    ...
    @include('customer.take_away.branch.setting')
    @include('customer.take_away.branch.update')
    @include('manage.food.brand.detail')
@endsection
@push('scripts')
    <script type="text/javascript"
            src="{{asset('js/customer/take_away/branch/index.js?version=3', env('IS_DEPLOY_ON_SERVER'))}}"></script>
@endpush
