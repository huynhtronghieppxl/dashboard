                ...
                <div class="cover-profile">
                    <div class="profile-bg-img">
                        <img class="profile-bg-img img-fluid"
                             src="{{$page_selected['cover']}}"
                             alt="bg-img">
                        <div class="card-block user-info">
                            <div class="col-md-12">
                                <div class="media-left">
                                    <a href="#" class="profile-image">
                                        <img class="rounded-circle" alt="user-img" src="{{$page_selected['avatar']}}">
                                    </a>
                                </div>
                                <div class="media-body row">
                                    <div class="col-lg-12">
                                        <div class="user-title" id="page-name">
                                            <h1 class="font-weight-bold text-white"
                                                data-page="{{$page_selected['name']}}">{{$page_selected['name']}}</h1>
                                            <span class="font-weight-bold text-muted">{{$page_selected['category']}}</span>
                                        </div>
                                    </div>
                                    <div>
            ...
            <div>
                <div class="bg-white p-relative">
                    <div class="card-block border">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <div class="chat-header font-weight-bold">{{$page_selected['name']}}</div>
                    ...
                    <div id="lightgallery" class="lightgallery-popup mb-5">
                        @if($feed['video'] !== null)
                            <iframe class="img-fluid mx-auto d-block" width="40%" src="{{$feed['video']}}"  style="border:none;overflow:hidden" scrolling="no"
                ...
                <div class="modal-body">
                    @foreach($all_page as $page)
                        <div class="card mb-3">
                            <div class="row p-3">
                                <div class="col-sm-2">
                                    <img class="media-object img-radius img-50" src="{{$page['avatar']}}">
                                </div>
                                <div class="col-sm-7 m-auto">
                                    <div class="row">
                                        <a class="float-left font-weight-bold font-16">{{$page['name']}}</a>
                                    </div>
                                    <div class="row">
                                ...
                                <div class="col-sm-3 m-auto">
                                    <button class="btn btn-primary m-auto" onclick="getPageByID({{$page['id']}})">Kết
                                        nối
                                    </button>
                                </div>
                            </div>
