    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
                ...
                <div class="row d-flex">
                    <div class="col-lg-8 edit-flex-auto-fill pr-1">
                        <div class="card card-block w-100">
                            ...
                            <div class="row">
                                <div class="col-lg-3 form-group select2_theme validate-group pl-0">
                                    <div class="form-validate-select">
                                            <div class="col-lg-12 select-material-box">
                                                <label
                                                    class="col-form-label">@lang('app.booking-table-manage.create-popup.select1')</label>
                                                <select id="select-category-food-assign-food-happy-time-promotion" class="js-example-basic-single select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                                                ...
                                                <label>
                                                    <i class="typcn typcn-document-text"></i>@lang('app.booking-table-manage.create-popup.select1')
                                                </label>
                                                <div class="line"></div>
                                            </div>
                                    </div>
                                ...
                                <div class="col-lg-9 form-group select2_theme validate-group pr-0">
                                    <div class="form-validate-select">
                                            <div class="col-lg-12 select-material-box">
                                                <label
                                                    class="col-form-label">@lang('app.booking-table-manage.create-popup.select2')</label>
                                                <select id="select-food-assign-food-happy-time-promotion" class="js-example-basic-single select2-hidden-accessible" data-select="1">
                                                </select>
                                                <label>
                                                    <i class="typcn typcn-document-text"></i>@lang('app.booking-table-manage.create-popup.select2')
                                                </label>
                                                <div class="line"></div>
                                            </div>
                                    </div>
                            ...
                            <div class="table-responsive">
                                <table class="table  table-bordered" id="table-food-assign-food-happy-time-promotion">
                                    <thead>
                                        <tr>
                                            <th>@lang('app.gift-marketing.create.stt')</th>
                                            <th>@lang('app.booking-table-manage.create.avatar')</th>
                                            <th>@lang('app.booking-table-manage.create.name')</th>
                                            <th>@lang('app.booking-table-manage.create.price')</th>
                                            <th></th>
                                        </tr>
                                    </thead>
                                    <tbody></tbody>
                    ...
                    <div class="col-lg-4 edit-flex-auto-fill pl-1">
                        <div class="card card-block flex-sub">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    <label class="f-w-600 col-form-label">@lang('app.happy-time-promotion.assign-food.max-happy-time-promotion')</label>
                                    <div class="f-w-400">
                            ...
                            <div class="form-group row border-dashed mb-4">
                                <div class="col-lg-12">
                                ...
                                <div class="form-validate-select">
                                    <div class="col-lg-12 mx-0 px-0">
                                        <div class="col-lg-12 pr-0 select-material-box">
                                            <select id="select-branch-assign-foo" data-select="1" class="js-example-basic-single select2-hidden-accessible" tabindex="-1" aria-hidden="true">
                                            ...
                                            <label>
                                                <i class="typcn typcn-document-text"></i>@lang('app.booking-table-manage.create.branch')
                            ...
                            <div class="form-group select2_theme validate-group">
                                <div class="form-validate-select">
                                        <div class="col-lg-12 pr-0 select-material-box">
                                            <label
                                                class="col-form-label">@lang('app.happy-time-promotion.assign-food.name')</label>
                                            <span class="d-none notify-valid text-center" id="add-error-span">@lang('app.happy-time-promotion.assign-food.name') </span>
                                            <select id="select-happy-time-promotion-assign-food" class="js-example-basic-single select2-hidden-accessible" data-select="1">
                                            </select>
                                            <label>
                                                <i class="typcn typcn-document-text"></i>@lang('app.happy-time-promotion.assign-food.name')
                                            </label>
                                            <div class="line"></div>
                                        </div>
                                </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="saveAssignFoodHappyTimePromotion()" id="btn-assign-food-happy-time-promotion">
