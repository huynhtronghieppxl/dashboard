<style>
    #chart-vertical-drink-report {
        background: #ffffff !important;
        height: 60vh !important;
    }
</style>
<div class="report-revenue card-inview-dashboard" id="drink-report" data-key="drink-report">
    <div class="revenue-month seemt-blue seemt-border-bottom seemt-bg-white d-flex">
        <div class="content-revenue-month seemt-before-blue">
            <p id="title-card1">@lang('app.branch-dashboard.food-drink-report.title-drink')</p>
        </div>
        <div class="d-flex" id="select-type-drink-report">
            <div class="checkbox-zoom zoom-primary d-flex align-items-center">
                ...
                <label class="focus-validate mb-0">
                    <input type="checkbox" name="check-detail" class="js-switch detail-value-drink-report">
                </label>
            </div>
            ...
            <div style="margin-left: 10px">
                <div class="select-filter-type-date">
                    <div class="select-material-box">
                        <select id="select-sort-goods-report"
            ...
            <div class="content-revenue-month-sub mb-0">
                <div class="row m-0 content-revenue-month-group">
                    <div class="col-lg-12 seemt-border-radius-6 content-revenue-month-chart-report">
                        <div id="chart-vertical-drink-report"
                             class="count-loading-chart h-100 w-100"></div>
                        <div id="chart-vertical-drink-report-empty"
...
@push('scripts')
    <script src="{{ asset('js/dashboard/branch/drink_report.js?version=3', env('IS_DEPLOY_ON_SERVER'))}}"
