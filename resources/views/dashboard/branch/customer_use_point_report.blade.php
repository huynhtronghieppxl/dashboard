<div class="card card-block card-inview-dashboard pt-2" id="customer-use-point-report" data-key="customer-use-point-report">
    <div class="row">
        <div class="sub-title p-0 col-lg-12 d-flex align-items-center justify-content-between pb-2">
            <h4 class="title-header-dashboard-report ml-0 mt-0 p-2 w-100">@lang('app.branch-dashboard.customer-use-point-report.title')
                <label class="title-header-dashboard-report" id="text-label-type-customer-use-point-report"></label>
            </h4>
                ...
                <div class="select-filter-type-date" id="time-bar-filter-order-manage">
                    <div class="form-validate-select position-relative">
                        <div class="select-material-box">
                            <select id="select-type-customer-use-point-report" class="js-example-basic-single select2-hidden-accessible form-control" tabindex="-1" aria-hidden="true">
...
@push('scripts')
    <script src="{{asset('js/dashboard/branch/customer_use_point_report.js?version=81', env('IS_DEPLOY_ON_SERVER'))}}" type="text/javascript"></script>
@endpush
