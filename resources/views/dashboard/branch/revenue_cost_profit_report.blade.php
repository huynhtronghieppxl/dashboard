<style>
    ...
    .progress-box .text-progress-box {
        /*width: 100%;*/
        flex: 40%;
        font-size: 14px !important;
    }
    .progress-box .text-progress-box2 {
        /*width: 100%;*/
        flex-basis: 60%;
    }
    .progress-box .text-progress-box3 {
        /*width: 100%;*/
        flex-basis: 50%;
    }

    .progress-box .text-progress-box4 {
        /*width: 100%;*/
        flex-basis: 50%;
    }
        ...
        <div class="revenue-content-sub mb-0">
            ...
            <div class="content-revenue-month-sub">
                <div class="row m-0 content-revenue-month-group">
                    <div class="col-lg-9 col-md-6 col-sm-12 seemt-border-radius-6 content-revenue-month-chart-report">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12 pr-0">
                        <div class="revenue seemt-report-item card-revenue-sub">
                            <div class="paid-revenue d-flex">
                                ...
                                <div class="content-revenue seemt-orange d-flex flex-wrap">
                                    ...
                                    <div class="col-1 p-0 text-center seemt-blue" data-toggle="tooltip" data-placement="top" data-original-title="Các hóa đơn ở trọng thái hoàn tất(bao gồm VAT)">
                        ...
                        <div class="revenue seemt-report-item card-revenue-sub">
                            <div class="paid-revenue d-flex">
                                ...
                                <div class="content-revenue seemt-orange d-flex flex-wrap">
                                    ...
                                    <div class="col-1 p-0 text-center seemt-red" data-toggle="tooltip" data-placement="top" data-original-title="Bao gồm các đơn hàng NCC, chi phí lương ước tính, phiếu chi có hạch toán">
                                        <i class="fi-rr-exclamation"></i>
                                    </div>
                                    <div class="total-revenue col-12 text-right">
                        ...
                        <div class="revenue seemt-report-item card-revenue-sub">
                            <div class="paid-revenue d-flex">
                                ...
                                <div class="content-revenue seemt-green d-flex flex-wrap">
                                    ...
                                    <div class="col-1 p-0 text-center seemt-green" data-toggle="tooltip" data-placement="top" data-original-title="Lợi nhuận ước tính = Doanh thu bán hàng - Chi phí ước tính">
                                        <i class="fi-rr-exclamation" ></i>
                                    </div>
                                    <div class="total-revenue col-12 text-right">
                        ...
                        <div class="revenue seemt-report-item card-revenue-sub">
                            <div class="paid-revenue d-flex">
                                ...
                                <div class="content-revenue seemt-orange d-flex flex-wrap">
                                    <div class="text-revenue col-11 p-0 text-right">
                                        <label class="m-0 mr-1">Tỷ suất lợi nhuận bán hàng ước tính</label>
                                    </div>
                                    <div class="col-1 p-0 text-center seemt-orange" data-toggle="tooltip" data-placement="top" data-original-title="Tỷ suất ước tính = ( Lợi nhuận ước tính / Doanh thu ước tính) * 100">
                                        <i class="fi-rr-exclamation" ></i>
                                    </div>
...
{{--    </div>--}}
    ...
    <div class="revenue-content row">
        <div class="revenue-content-sub col-6 mb-0 pr-0">
            <div class="revenue-month seemt-green seemt-border-bottom">
...
{{--                        <i class="fa fa-exclamation-circle" data-toggle="tooltip" data-placement="top" data-original-title="@lang('app.branch-dashboard.revenue-cost-profit-report.note-revenue')"></i>--}}
                            ...
                            <div class="tool-box">
                                <div data-toolbar="user-options">
                                    <i class="fi-rr-exclamation" style="vertical-align: sub"
                                       ...
                                       data-original-title="@lang('app.branch-dashboard.revenue-cost-profit-report.note-present')"></i>
                                </div>
                                <div class="clear"></div>
                            </div>
                        </label>
        ...
        <div class="revenue-content-sub col-6 mb-0">
            <div class="revenue-month seemt-green seemt-border-bottom">
                <div class="title-revenue-month-sub seemt-before-green seemt-fz-20 d-flex" style="margin-top: -4px">
...
{{--                        <i class="fa fa-exclamation-circle" data-toggle="tooltip" data-placement="top" data-original-title="@lang('app.branch-dashboard.revenue-cost-profit-report.note-revenue')"></i>--}}
            ...
            <div class="content-revenue-month-sub card-revenue-sub">
                <div class="row m-0 content-revenue-month-group">
...
{{--<div class="card card-block card-shadow-custom-dashboard card-inview-dashboard" id="revenue-cost-profit-report" data-key="revenue-cost-profit-report">--}}
{{--    <div class="row">--}}
...
{{--                    <div class="card app-design card-shadow-custom feed-card flex-sub  loading-reveneu-report">--}}
{{--                        <div class="row m-0 p-0 sub-title">--}}
{{--                            <h5>@lang('app.branch-dashboard.revenue-cost-profit-report.chart2_card2_title')--}}
{{--                                <i class="fa fa-exclamation-circle" data-toggle="tooltip" data-placement="top" data-original-title="@lang('app.branch-dashboard.revenue-cost-profit-report.note-present')"></i>--}}
{{--                            </h5>--}}
{{--                        </div>--}}
{{--                        <div class="card-block " id="rate-one-revenue-cost-profit-report" style="height: 300px">--}}
{{--                            --}}{{--                                <div class="progress-box">--}}
{{--                            --}}{{--                                    <p class="m-r-20 f-w-400">Tỷ trọng doanh thu: 70,000/100,000</p>--}}
{{--                            --}}{{--                                    <div class="progress d-inline-block">--}}
{{--                            --}}{{--                                        <div class="progress-bar bg-c-green" style="width:0% ">--}}
{{--                            --}}{{--                                            <label class="label label-lg label-danger" style="top: -35px;">--}}
{{--                            --}}{{--                                                -30% <i class="m-l-10 feather icon-arrow-down"></i>--}}
{{--                            --}}{{--                                            </label>--}}
{{--                            --}}{{--                                        </div>--}}
{{--                            --}}{{--                                    </div>--}}
{{--                            --}}{{--                                </div>--}}
{{--                            --}}{{--                                <div class="progress-box">--}}
{{--                            --}}{{--                                    <p class="m-r-20 f-w-400">Doanh thu: 70,000</p>--}}
{{--                            --}}{{--                                    <div class="progress d-inline-block">--}}
{{--                            --}}{{--                                        <div class="progress-bar bg-c-blue" style="width:70% "><label>70%</label></div>--}}
{{--                            --}}{{--                                    </div>--}}
{{--                            --}}{{--                                </div>--}}
{{--                            --}}{{--                                <div class="progress-box">--}}
{{--                            --}}{{--                                    <p class="m-r-20 f-w-400">Tiền vốn: 100,000</p>--}}
{{--                            --}}{{--                                    <div class="progress d-inline-block">--}}
{{--                            --}}{{--                                        <div class="progress-bar bg-c-yellow" style="width:100% "><label>100%</label></div>--}}
{{--                            --}}{{--                                    </div>--}}
{{--                            --}}{{--                                </div>--}}
{{--                        </div>--}}
{{--                    </div>--}}
...
{{--                    <div class="card app-design card-shadow-custom feed-card w-100  loading-reveneu-report">--}}
{{--                        <div class="row m-0 p-0 sub-title">--}}
{{--                            <h5>@lang('app.branch-dashboard.revenue-cost-profit-report.chart4_card2_title')--}}
{{--                                <i class="fa fa-exclamation-circle" data-toggle="tooltip" data-placement="top" data-original-title="@lang('app.branch-dashboard.revenue-cost-profit-report.note-revenue')"></i>--}}
{{--                            </h5>--}}
{{--                        </div>--}}
{{--                        <div class="card-block " id="rate-two-revenue-cost-profit-report" style="height: 300px"></div>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--                <div class="col-lg-6 col-xl-6 edit-flex-auto-fill p-l-0">--}}
{{--                    <div class="card app-design card-shadow-custom feed-card w-100  loading-reveneu-report">--}}
{{--                        <div class="row m-0 p-0 sub-title">--}}
{{--                            <h5>TỶ TRỌNG KHO BỘ PHẬN--}}
{{--                                <i class="fa fa-exclamation-circle" data-toggle="tooltip" data-placement="top" data-original-title="@lang('app.branch-dashboard.revenue-cost-profit-report.note-revenue')"></i>--}}
{{--                            </h5>--}}
{{--                        </div>--}}
{{--                        <div class="card-block " id="rate-three-revenue-cost-profit-report" style="height: 300px"></div>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
...
{{--</div>--}}
{{--</div>--}}
@include('dashboard.branch.detail.revenue_cost_profit')
@push('scripts')
    <script src="{{asset('js/dashboard/branch/revenue_cost_profit_report.js?version=81', env('IS_DEPLOY_ON_SERVER'))}}" type="text/javascript"></script>
@endpush
