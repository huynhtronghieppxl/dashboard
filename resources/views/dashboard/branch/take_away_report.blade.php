<style>
    #chart-take-away-report {
        background: #ffffff !important;
        height: 60vh !important;
    }
</style>
<div class="report-revenue card-inview-dashboard" id="take-away-report" data-key="take-away-report">
        ...
        <div class="d-flex" id="select-type-order-report">
            <div class="checkbox-zoom zoom-primary d-flex align-items-center">
                ...
                <label class="focus-validate mb-0">
                    <input type="checkbox" name="check-food" class="js-switch" id="detail-take-away-report">
                </label>
            </div>
            <div class="select-filter-type-date" id="time-bar-filter-order-manage">
                <div class="form-validate-select position-relative">
                    <div class="select-material-box">
                        <select id="select-take-away-report" class="js-example-basic-single select2-hidden-accessible form-control" tabindex="-1" aria-hidden="true">
            ...
            <div style="margin-left: 10px">
                <div class="select-filter-type-date">
                    <div class="select-material-box">
                        <select id="select-sort-take-away-report"
            ...
            <div class="bell ml-4">
                <div class="bit-icon seemt-green seemt-bg-green seemt-btn-hover-green" onclick="reloadTakeAwayReport()">
        ...
        <div class="content-revenue-month-sub">
            <div class="row m-0 content-revenue-month-group">
                <div class="col-lg-12 seemt-border-radius-6 content-revenue-month-chart-report">
                    <div id="chart-take-away-report" class="count-loading-chart h-100 w-100"></div>
                    <div id="chart-take-away-report-empty" class="d-flex align-center justify-content-center d-none">
...
@push('scripts')
    <script src="{{asset('js/dashboard/branch/take_away_report.js?version=2', env('IS_DEPLOY_ON_SERVER'))}}" type="text/javascript"></script>
@endpush
