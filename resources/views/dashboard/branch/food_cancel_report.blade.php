<style>
    #chart-food-cancel-report {
        background: #ffffff !important;
        height: 60vh !important;
    }
</style>
<div class="report-revenue card-inview-dashboard" id="food-cancel-report" data-key="food-cancel-report">
        ...
        <div class="d-flex" id="select-type-order-report">
            <div class="checkbox-zoom zoom-primary d-flex align-items-center">
                ...
                <label class="focus-validate mb-0">
                    <input type="checkbox" name="check-food" class="js-switch" id="detail-value-food-cancel-report">
                </label>
            </div>
            <div class="select-filter-type-date" id="time-bar-filter-order-manage">
                <div class="form-validate-select position-relative">
                    <div class="select-material-box">
                        <select id="select-food-cancel-report" class="js-example-basic-single select2-hidden-accessible form-control" tabindex="-1" aria-hidden="true">
            ...
            <div style="margin-left: 10px">
                <div class="select-filter-type-date">
                    <div class="select-material-box">
                        <select id="select-sort-food-cancel-report"
            ...
            <div class="bell ml-4">
                <div class="bit-icon seemt-green seemt-bg-green seemt-btn-hover-green" onclick="reloadFoodCancelReport()">
        ...
        <div class="content-revenue-month-sub">
            <div class="row m-0 content-revenue-month-group">
                <div class="col-lg-12 seemt-border-radius-6 content-revenue-month-chart-report">
                    <div id="chart-food-cancel-report" class="count-loading-chart h-100 w-100"></div>
                    <div id="chart-food-cancel-report-empty" class="d-flex align-center justify-content-center d-none">
...
@push('scripts')
    <script src="{{asset('js/dashboard/branch/food_cancel_report.js?version=2', env('IS_DEPLOY_ON_SERVER'))}}" type="text/javascript"></script>
@endpush
