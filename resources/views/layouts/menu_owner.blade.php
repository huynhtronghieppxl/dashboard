<style>
    ...
    .seemt-menu-sub-item.disabled {
        opacity: 1 !important;
    }

    .seemt-menu-sub-item.disabled > a {
        opacity: 0.6;
        user-select: none;
    }

    .seemt-menu-sub-item.disabled > a:hover {
        color: inherit;
    }
</style>
                ...
                <div class="seemt-menu-sub">
                    ...
                    <div class="seemt-menu-sub-item">
                        <a href="{{ route('customer.customers.index') }}">@lang('modules.menu.nav.customer.customers')
                            <label>
                                <i class="fi-rr-building icon-restaurant" data-toggle="tooltip" data-placement="top"
                                   data-original-title="Thực hiện trên Công ty"></i>
                            </label>
                        </a>
                    </div>
