...
{{--                </div>--}}
{{--                <div class="seemt-menu-sub-item">--}}
{{--                    <a href="{{ route('dashboard.branch-dashboard.index') }}">Tổng quan</a>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
        <div class="seemt-menu-item"  >
                ...
                <div class="seemt-menu-sub-item">
                    ...
                    <div class="seemt-menu-sub-last">
                        ...
                        <div class="seemt-menu-sub-item">
                            ...
                            <div class="seemt-menu-sub-last">
                                <div class="seemt-menu-sub-item"><a
                                        href="{{ route('manage.warehouse.goods-purchase-warehouse.index') }}">Quản lý mua hàng
                                        <label>
                                ...
                                <div class="seemt-menu-sub-item"><a
                                        href="{{ route('manage.warehouse.export-inventory-warehouse.index') }}">Xuất xuống kho chi nhánh
                                        <label>
                                            <i class="fi-rr-marker icon-branch" data-toggle="tooltip" data-placement="right"
                                               data-original-title="Thực hiện trên chi nhánh"></i>
                                        </label>
                                ...
                                <div class="seemt-menu-sub-item">
                                    <a href="{{ route('manage.warehouse.assign-warehouse-branch.index') }}">Gán kho chi nhánh
                                        <label>
                                            <i class="fi-rr-marker icon-branch" data-toggle="tooltip" data-placement="right"
                                               data-original-title="Thực hiện trên chi nhánh"></i>
                                        </label>
            ...
            <div class="seemt-menu-sub">
                ...
                <div class="seemt-menu-sub-item">
                    ...
                    <div class="seemt-menu-sub-last">
                        ...
                        <div class="seemt-menu-sub-item"><a href="{{ route('report.sell.order-report.index') }}">Hoá
                                đơn
                                <label>
                                    <i class="fi-rr-marker icon-branch" data-toggle="tooltip" data-placement="right"
                                       data-original-title="Thực hiện trên chi nhánh"></i>
...
{{--                <div class="seemt-menu-sub-item">--}}
{{--                    <a href="{{ route('report.all-report.index') }}">Báo cáo Demo--}}
{{--                        <label>--}}
{{--                            <i class="fi-rr-marker icon-branch" data-toggle="tooltip" data-placement="right"--}}
{{--                               data-original-title="Thực hiện trên chi nhánh"></i>--}}
{{--                        </label>--}}
...
{{--                </div>--}}
                ...
                <div class="seemt-menu-sub-item">
                    ...
                    <div class="seemt-menu-sub-last">
                        <div class="seemt-menu-sub-item">
                            ...
                            <div class="seemt-menu-sub-last">
                                <div class="seemt-menu-sub-item"><a
                                        href="{{ route('report.warehouse_report.material.warehouse-material-report.index') }}">Nhập xuất
                                        <label>
                                            <i class="fi-rr-marker icon-branch" data-toggle="tooltip"
                                               data-placement="right"
                                               data-original-title="Thực hiện trên chi nhánh"></i>
                                ...
                                <div class="seemt-menu-sub-item"><a
                                        href="{{ route('report.warehouse_report.inventory.warehouse-inventory-report.index') }}">Kiểm kê
                                        <label>
                                            <i class="fi-rr-marker icon-branch" data-toggle="tooltip"
                                               data-placement="right"
                                               data-original-title="Thực hiện trên chi nhánh"></i>
        ...
        @if (
            (Session::get(SESSION_KEY_LEVEL) > 5 && in_array('OWNER', Session::get(SESSION_PERMISSION))) ||
                in_array('WEB_MENU_ALOLINE', Session::get(SESSION_PERMISSION)))
            <div class="seemt-menu-item"  >
                <a>
...
{{--        @if ((Session::get(SESSION_KEY_LEVEL) > 5 && in_array('OWNER', Session::get(SESSION_PERMISSION))) ||--}}
{{--                in_array('WEB_MENU_SALE_CHANNEL', Session::get(SESSION_PERMISSION)))--}}
{{--            <div class="seemt-menu-item">--}}
{{--                <a href="#">--}}
{{--                    <i class="fi-rr-shop"></i>--}}
{{--                    <div class="seemt-menu-title">--}}
{{--                        <span class="">Bán Hàng Online</span>--}}
{{--                        <i class="fi-rr-angle-small-down"></i>--}}
{{--                    </div>--}}
{{--                </a>--}}
{{--                <div class="seemt-menu-sub">--}}
{{--                    <div class="seemt-menu-sub-title">Bán Hàng Online</div>--}}
{{--                    <div class="seemt-menu-sub-item">--}}
{{--                        <a href="/facebook-auth.login.index">@lang('modules.menu.nav.sell_online.facebook')</a>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        @endif--}}
        <div class="seemt-menu-item">
            ...
            <div class="seemt-menu-sub">
                ...
                @if (Session::get(SESSION_KEY_LEVEL) > 5)
                    <div class="seemt-menu-sub-item"><a
                            href="{{ route('setting.offline-setting.index') }}">@lang('modules.menu.nav.setting.setting.offline')
                            <label>
                                <i class="fi-rr-bank icon-brand" data-toggle="tooltip" data-placement="right"
                                   data-original-title="Thực hiện trên thương hiệu"></i>
                            </label>
                ...
                @endif
                <div class="seemt-menu-sub-item"><a href="{{ route('setting.service-cost-history.index') }}">Lịch sử
                        chi phí dịch vụ
                        <label>
                            <i class="fi-rr-bank icon-brand" data-toggle="tooltip" data-placement="right"
                               data-original-title="Thực hiện trên thương hiệu"></i>
