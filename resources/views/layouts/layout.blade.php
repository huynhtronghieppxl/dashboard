...
<head>
    ...
    <title>@lang('modules.head.title')</title>
...
<div class="seemt-container">
    ...
    <div class="seemt-main-container" id="content-body-techres">
        ...
        @else
            @include('layouts.menu_sell_solution')
        @endif
...
<script>
    $(function () {
        ...
        $('.select-brand').on('change', function () {
            ...
            let allBranch = [
                'branch-dashboard', 'service-cost-history-report'
            ];
            if (allBranch.includes(window.location.pathname.slice(1))) {
    ...
    //     $(this).attr('data-is-click', 1)
    //     $(this).children('.seemt-menu-sub').attr("style", "");
    //     if ($(this).children('.seemt-menu-sub').hasClass('d-block')) {
    //         $(this).children('.seemt-menu-sub').removeClass('d-block')
    //     } else {
    //         $('.seemt-menu-sub').removeClass('d-block');
    //         $('.seemt-menu-sub-last').removeClass('d-block');
    //         $(this).children('.seemt-menu-sub').addClass('d-block')
    //     }
    //     $('.seemt-menu-sub-last').removeClass('d-block');
    //     if ($(this).find('.seemt-menu-sub').hasClass('d-block')) {
    //         let winHeight = $('.seemt-container').height();
