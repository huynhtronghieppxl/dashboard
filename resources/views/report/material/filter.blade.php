<div class="select-filter-dataTable">
    ...
    <div class="time-filer-dataTale">
        <div class="seemt-group-date">
            ...
            <input class="from-date-material-report" type="text" value="1/{{date('m/Y')}}">
        </div>
        <span class="input-group-addon custom-find seemt-gray-w600"><i class="fi-rr-angle-double-small-right"></i></span>
        <div class="seemt-group-date">
            <i class="fi-rr-calendar"></i>
            <input class="to-date-material-report" type="text" value="{{date('d/m/Y')}}">
        </div>
        <button class="search-btn-material-report"><i class="fi-rr-filter"></i></button>
    </div>
</div>
