<table id="table-export-discount-report" class="d-none">
    ...
    <tr style="height:30px; text-align: center">
        <th colspan="3" id="title-excel-discount-report" style="background-color: #c5c5c5">@lang('app.sell-report.card5.title-excel') <span></span></th>
    </tr>
    <tr style="height:30px; text-align: center; font-weight: bold">
        ...
        <th style="width: 130px;background-color: #f2f2f2;vertical-align: middle;">@lang('app.sell-report.card5.value-table')</th>
    </tr>
    <tr>
        <th id="total-value-sell-discount-report" style="background-color: #f2f2f2">
            <label></label>
        </th>
    </tr>
    </thead>
