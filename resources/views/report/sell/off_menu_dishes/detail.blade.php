<div class="modal fade" id="modal-detail-off-menu-sell-report" data-keyboard="false" data-backdrop="static">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content card-shadow-custom">
            <div class="modal-header">
                ...
                <button type="button" class="close" onclick="closeModalDetailOffMenuSellReport()" onkeypress="closeModalDetailOffMenuSellReport()">
                    <i class="fi-rr-cross"></i>
                </button>
            </div>
            <div class="modal-body background-body-color seemt-main-content" id="loading-modal-detail-off-menu-sell-report">
                <div class="row">
                    <div class="col-lg-8 edit-flex-auto-fill pr-0">
                        <div class="card card-block w-100">
                            ...
                            <div class="table-responsive new-table">
                                <table class="table" id="table-detail-off-menu-sell-report">
                                    <thead>
                                    <tr>
                                    ...
                                    <tr>
                                        <th id="total-amount-amount-detail-food-sell-report">0</th>
                                        <th id="total-amount-using-slot-table-detail-food-sell-report">0</th>
                                    </tr>
                                    </thead>
                                </table>
                            </div>
                        ...
                        <div class="card card-block flex-sub">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <h6 class="text-muted f-w-400 col-form-label-fz-15" id="name-detail-off-menu-sell-report">---</h6>
                                </div>
                                <div class="col-lg-6">
                                    <label class="f-w-600 col-form-label col-form-label-fz-15">@lang('app.sell-report.detail-food.rate-profit') (%)</label>
                                    <h6 class="text-muted f-w-400 col-form-label-fz-15" id="rate-profit-detail-off-menu-sell-report">0</h6>
                                </div>
                            </div>
                            <div class="form-group row border-dashed pb-2 mb-1">
                                <div class="col-lg-6">
                                    ...
                                    <h6 class="text-muted f-w-400 col-form-label-fz-15" id="original-detail-off-menu-sell-report">0</h6>
                                </div>
                                <div class="col-lg-6">
                                    <label class="f-w-600 col-form-label col-form-label-fz-15">@lang('app.sell-report.detail-food.price')</label>
                                    <h6 class="text-muted f-w-400 col-form-label-fz-15" id="price-detail-off-menu-sell-report">0</h6>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <h6 class="text-muted f-w-400 col-form-label-fz-15" id="profit-detail-off-menu-sell-report">0</h6>
                                </div>
                            </div>
                        </div>
                    </div>
...
@push('scripts')
    ...
    {{--            src="/js/report/sell/detail_food.js?version=1')}}"></script>--}}
    <script type="text/javascript" src="{{ asset('/js/report/sell/food/detail.js?version=1', env('IS_DEPLOY_ON_SERVER'))}}"></script>
{{--    <script type="text/javascript" src="/js/report/profit/detail.js?version=1"></script>--}}
{{--    <script type="text/javascript"--}}
{{--            src="/js/report/profit/index.js?version=7"></script>--}}
    <script type="text/javascript"
            src="{{ asset('js/report/sell/off_menu_dishes/detail.js?version=1', env('IS_DEPLOY_ON_SERVER'))}}"></script>
@endpush
