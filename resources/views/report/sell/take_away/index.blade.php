...
@section('content')
    <style>
        ...
        .seemt-main-content .select-filter-dataTable .select2-container--default .select2-selection--single .select2-selection__rendered {
        ...
        #detail-value-take-away-report-box {
            position: absolute;
            right: 0;
            z-index: 1;
        }
            ...
            <div class="card" id="content-detail">
                <div class="row">
                    <div class="col-lg-12 d-flex align-items-center">
                        <div class="col-12" id="filter-sell-take-away-report">
                            <div class="filter-report row seemt-green" style="height: 32px">
                                <div class="form-group select2_theme validate-group col-lg-2"
                                ...
                                <div class="col-lg-3 pl-0 d-flex align-items-center justify-content-start"
                                     style="height: 32px" id="time-filter-category-report">
                                            ...
                                            <div class="form-validate-select">
                                                <div class="col-lg-12 mx-0 px-0">
                                                    <div class="col-lg-12 pr-0 select-material-box">
                                                        <select id="select-sort-sell-take-away-report"
                                                                class="form-control js-example-basic-single select2-hidden-accessible">
                                                            <option
                        ...
                        <div class="card-block-big pt-0 pb-2 selections" id="data-chart">
                            <div id="chart-sell-report-vertical" class="mt-0 vertical-chart count-loading-chart">
                                <div class="col-lg-12 d-flex align-items-center justify-content-end mt-2"
                                     id="detail-value-take-away-report-box">
                                    <div class="form-validate-checkbox d-flex flex-row-reverse p-0">
                                        <div class="checkbox-form-group">
                                            <input type="checkbox" value="" id="detail-value-take-away-report"
                                                   required=""/>
                                            <label class="name-checkbox" for="detail-value-take-away-report"> Xem Chi
                                                tiết </label>
                                        </div>
                                    </div>
                                </div>
                                <div id="chart-sell-take-away-report-vertical-empty"
                                     class="empty-datatable-custom center-loading d-none"><img style="width: 200px"
                                                                                               src="../../../../images/tms/empty.png">
                                </div>
                                <div id="chart-sell-take-away-report-vertical-main" style="height: 100%; width: 98%"
                                     class="mt-4 vertical-chart count-loading-chart center-loading">
                                </div>
                            </div>
                        </div>
                        <div class="card-body selections">
                            <div class="table-responsive new-table table-container-loading" id="table-card6">
                                <table id="table-sell-card6-report" class="table">
                                    <thead>
                                    <tr>
                                        <th rowspan="2"
                                    ...
                                    <tr>
                                        <th class="seemt-fz-14" id="total-quantity-card6">0</th>
                                        <th class="seemt-fz-14" id="total-original-card6">0</th>
                                        <th class="seemt-fz-14" id="total-money-card6">0</th>
                                        <th class="seemt-fz-14" id="total-profit-card6">0</th>
                                    </tr>
                                    </thead>
                                </table>
                            </div>
    ...
    @include('report.sell.detail_take_away')
    @include('report.sell.take_away.excel')
    @include('manage.bill.detail')
@endsection
@push('scripts')
    {{--    <script src="https://cdnjs.cloudflare.com/ajax/libs/echarts/5.3.3/echarts.min.js"></script>--}}
    <script type="text/javascript"
            src="{{ asset('..\js\report\sell\take_away\index.js?version=10', env('IS_DEPLOY_ON_SERVER'))}}"></script>
    <script type="text/javascript"
            src="{{ asset('/js/report/sell/filter.js?version=1', env('IS_DEPLOY_ON_SERVER'))}}"></script>
@endpush
