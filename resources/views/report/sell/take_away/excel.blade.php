<table id="table-export-take-away-report" class="d-none">
    <thead>
    ...
    <tr style="height:30px; text-align: center">
        <th colspan="8" id="title-excel-take-away-report" style="background-color: #c5c5c5">@lang('app.sell-report.card6.title-excel') <span></span></th>
    </tr>
    <tr style="height:30px; text-align: center; font-weight: bold">
        ...
        <th rowspan="2" style="width: 130px;background-color: #f2f2f2;vertical-align: middle;">@lang('app.sell-report.card2.unit-table')</th>
    ...
    <tr>
        <th id="total-quantity-sell-take-away-report" style="background-color: #f2f2f2">
            <label></label>
        </th>
        <th id="total-original-sell-take-away-report" style="background-color: #f2f2f2">
            <label></label>
        </th>
        <th id="total-money-sell-take-away-report" style="background-color: #f2f2f2">
            <label></label>
        </th>
        <th id="total-profit-sell-take-away-report" style="background-color: #f2f2f2">
            <label></label>
        </th>
    </tr>
    </thead>
...
@push('scripts')
    <script type="text/javascript" src="{{ asset('..\js\report\sell\take_away\export.js?version=1', env('IS_DEPLOY_ON_SERVER'))}}"></script>
@endpush
