...
<div class="filter-report seemt-green " style="height: 32px; display: flex; justify-content: space-between">
    <div class="col-lg-5 d-flex">
        <div class="form-group select2_theme validate-group col-lg-5" style="margin: 0 !important;">
        ...
        <div class="col-lg-7 pl-0 d-flex align-items-center justify-content-start" style="height: 32px">
        <div class=" input-group m-auto add-display border-0 p-0 form-day-time-filter d-flex"
            ...
            <div class="time-filer-dataTale time-input-filter-time-bar custom-date border-0">
                <div class="filter-date d-flex align-items-center">
                    ...
                    <button
                        class="icon-filter-component search-date-filter-time-bar seemt-bg-blue custom-button-search seemt-btn-hover-blue  m-0" style="">
...
@push('scripts')
    <script type="text/javascript" src="{{ asset('..\js\report\sell\filter.js?version=1') }}"></script>
@endpush
