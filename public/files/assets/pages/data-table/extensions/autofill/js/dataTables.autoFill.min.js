...
(function (e) {
        ...
        _actionSelector: function (c) {
            ...
            if (a) {
                for (var d = {}, f = [], e = a.fields(), g = 0, i = c.length; g < i; g++) for (var j = 0, l = c[g].length; j < l; j++) {
                    var n = c[g][j], k = b.settings()[0].aoColumns[n.index.column], m = k.editField;
                    if (m === q) for (var k = k.mData, p = 0, o = e.length; p < o; p++) {
                        var r = a.field(e[p]);
                        if (r.dataSrc() === k) {
                            m = r.name();
                            break
    ...
    j.version = "2.1.3";
    j.defaults = {alwaysAsk: !1, focus: null, columns: "", update: null, editor: null};
    j.classes = {btn: "btn"};
