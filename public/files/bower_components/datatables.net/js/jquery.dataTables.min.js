...
(function (h) {
    ...
    function rb(a) {
        var b = a.oClasses, c = a.sTableId, d = a.oLanguage, e = a.oPreviousSearch, f = a.aanFeatures,
            g = '<input type="search" placeholder="' + b.sPlaceholder + '" class="' + b.sFilterInput + '"/>', j = d.sSearch,
