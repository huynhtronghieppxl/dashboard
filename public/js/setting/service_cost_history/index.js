...
$(function(){
    dateTimePickerMonthYearTemplate($('.input-time-month-service-cost'));
    dateTimePickerMonthYearTemplate($('.from-month-service-cost'));
    dateTimePickerMonthYearTemplate($('.to-month-service-cost'));
    dateTimePickerTemplate($('.input-time-day-service-cost'));
    dateTimePickerYearTemplate($('.input-time-year-service-cost'));
    dateTimePickerYearTemplate($('.from-year-service-cost'));
    dateTimePickerYearTemplate($('.to-year-service-cost'));
    dateTimePickerFromMaxToDate($('.from-day-service-cost'), $('.to-day-service-cost'));
    loadDataBalance();
...
async function loadDataBalance(){
    ...
    $('#total-add-service-cost-history').text(formatNumber(res.data.data.amount_transfer));
    $('#total-minus-service-cost-history').text(formatNumber(res.data.data.used_amount));
...
function callbackServiceCostHistory(response) {
    ...
    $('#total-amount-service-cost-history-add').text(formatNumber(response.config[0].data.total_amount));
    $('#total-amount-service-cost-history-minus').text(formatNumber(response.config[0].data.total_amount));
}
